    ...
    render () {
        ...
        return (
            <Aux>
                ...
                <BuildControls price={this.state.totalPrice} disabled={disabledInfo} addedIngredient={this.addIngredientHandler} removedIngredient={this.removeIngredientHandler} />
            </Aux>
        );
    }
}
